...
const (
	...
	// ErrAuxPowValidation indicates that there was an error while attempting
	// to validate the AuxPow header of the block.
	ErrAuxPowValidation
)
...
var errorCodeStrings = map[ErrorCode]string{
	...
	ErrAuxPowValidation:      "ErrAuxPowValidation",
}
